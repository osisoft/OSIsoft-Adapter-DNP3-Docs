...
| **StreamIdPrefix** | Optional | `string` | Specifies what prefix is used for Stream IDs.
**Note:** An empty string means no prefix will be added to the Stream IDs. Specifying `null` or omitting this parameter will result in the ComponentID followed by a dot character being used to prefix the Stream IDs. |
